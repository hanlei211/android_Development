...
import static com.rjyx.quickdevelopment.util.UIUtils.getColor;
...
public class ThemeUtils {
    ...
    private int primaryColor;//  <!--状态栏颜色 -->
    private int accentColor;//<!--控制各个控件被选中时的颜色-->
